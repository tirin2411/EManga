...
namespace ViewModels.System.Users
{
    public class RegisterRequestValidator : AbstractValidator<RegisterRequest>
    {
        ...
        {
            RuleFor(x => x.Ten).NotEmpty().WithMessage("First name is required")
                .MaximumLength(200).WithMessage("First name can not over 200 characters");

            RuleFor(x => x.Ho).NotEmpty().WithMessage("Last name is required")
            ...
            //RuleFor(x => x.GioiTinh).NotEmpty().WithMessage("Sex is required");
